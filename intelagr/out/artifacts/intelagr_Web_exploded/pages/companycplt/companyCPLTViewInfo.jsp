		...
		<fieldset class="fieldset_common_style">
			<table class="table_common_style">
				...
				<tr>
					...
					<td class="table_common_td_txt_style">
						<s:showName entityName="CommonData" codeKey="SettleStatus" value="${r.settleStatus}"></s:showName></td>
				</tr>
				<tr>
					<td class="table_common_td_label_style">处理人：</td>
					<td class="table_common_td_txt_style">${companyCPLT.processor}
						</td>
				</tr>
				<tr>
					<td class="table_common_td_label_style">处理日期：</td>
					<td class="table_common_td_txt_style">${companyCPLT.settleDate}
						</td>
				</tr>
				<tr>
					<td class="table_common_td_label_style">处理方式：</td>
					<td class="table_common_td_txt_style">${companyCPLT.processMode}
						</td>
				</tr>
				<tr>
