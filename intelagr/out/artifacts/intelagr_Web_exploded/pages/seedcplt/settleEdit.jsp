		...
		<table class="n_input" border="0" align="center" width="95%">
					...
					<table width="100%" border="0">
						<tr>
							...
							<td width="25%">
								...
								<s:select id="companyCode1" name="companyCode" codeKey="01" entityName="Company" width="170" value="${seedCPLT.companyCode}" readOnly="true"/>
							</td>
						</tr>
						<tr>
            ...
            data-options="required:true,showSeconds:false" style="width:170px" readOnly>
						...
						<tr>
							...
							<td colspan="3">
								<textarea class="easyui-textbox" rows="2" style="width:465px;height:60px" id='complaintContent' name="complaintContent" data-options="multiline:true" readOnly>${seedCPLT.complaintContent}</textarea>
							</td>
						</tr>
					</table>
					</fieldset>
					...
					<table width="100%" border="0">
						...
						<tr>
							<td align="right" width="10%" nowrap="nowrap">
								涉及种子数量(斤)：</td>
							<td>
								<input type="text" name="productionWeight" value="${seedCPLT.productionWeight}" id="productionWeight"/>
							</td>
						</tr>
						<tr>
							<td align="right" width="10%" nowrap="nowrap">
							...
							<td>
							拉黑时长：<s:select id='blackListTimeLimit' name="blackListTimeLimit" value="${blackListTimeLimit}" codeKey="BlackListDuration" entityName="commonData" hasPleaseSelectOption="false" width="170"/><BR>
							</td>
						</tr>
						<tr>
...
<%--								<input class="easyui-datebox" name="settleDate" id="settleDate" value="${seedCPLT.settleDate}" data-options="required:true,showSeconds:false,editable:false" style="width:170px">--%>
								<input class="easyui-datebox" name="settleDate"  value="$${seedCPLT.settleDate}" data-options="required:true,showSeconds:false,editable:false" style="width:170px">
	...
	function save(){
		...
		showLoading();
		Public.ajaxPost('/seedCPLT/saveSettle', JSON.stringify(a), function(e) {
			alert(e.status);
			hideLoading();
			if (200 == e.status) {
